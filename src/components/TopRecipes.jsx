  ...
  return (
    <div className="results-wrapper pb-5 mb-5">
      ...
      <div className="grid-container py-5">
        <div className="grid xs:grid-flow-row sm:grid-flow-col gap-3 sm:overflow-x-auto xs:overflow-y-auto">
          <div className="recipe-card sm:w-[290px] xs:w-[100%]">
            ...
            <div className="recipe-card-content">
              ...
              <div className="truncate-card-text text-[14px] my-3">
                <p>
                  Ah, I see the issue now! If some cards are smaller because of
                  their content (e.g., titles or descriptions being shorter),
                  you can make all the cards
                </p>
              </div>
